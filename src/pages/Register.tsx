...
function Register() {
  ...
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 to-blue-900/70"></div>
      
      {/* Content */}
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-2xl">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-2">Join TravelHub</h2>
            <p className="text-white/80">Create your account and start exploring</p>
          </div>
